...
def create_frame_23(params: dict):
    l1 = params["l1"]
    l2 = params["l2"]
    h1 = params["h1"]
    h2 = params["h2"]
    ...
    node4 = Node(name='E', x=l2 / 2, y=h1, is_hinge=True)
    node5 = Node(name='5', x=l2, y=h1)
    node6 = Node(name='B', x=l2, y=0)
    node7 = Node(name='7', x=l2, y=h1 + h2 * 0.5)
    node8 = Node(name='8', x=l2 + l1 * 0.75, y=h1 + h2)
    node9 = Node(name='9', x=l2 + l1 * 1.5, y=h1 + h2 * 0.5)
    node10 = Node(name='10', x=l2 + l1 * 1.5, y=h1)
    node11 = Node(name='C', x=l2 + l1 * 1.5, y=0)
    node12 = Node(name='T', x=l2 * 1.5 + l1 * 1.5, y=h1, is_hinge=True)
    node13 = Node(name='13', x=l2 * 2 + l1 * 1.5, y=h1)
    node14 = Node(name='K', x=l2 * 2 + l1 * 1.5, y=h1 * 0.5)
    node15 = Node(name='D', x=l2 * 2 + l1 * 1.5, y=0)
    ...
    rod6 = Rod(start_node=node5, end_node=node7)
    ...
    rod11 = Rod(start_node=node10, end_node=node12, stiffness=i2)
    rod12 = Rod(start_node=node12, end_node=node13, stiffness=i2)
    ...
    support2 = Support(node=node6, number_of_reactions=3, rotation=90)
    support3 = Support(node=node11, number_of_reactions=3, rotation=90)
    support4 = Support(node=node15, number_of_reactions=2, rotation=90)
    ...
    if load_index == 1:
        ...
        loads = [load_P1, load_q1, load_q2, load_q3, load_q4]
        nodes = [node1, node2, node3, node4, node5, node6, node7, node8, node9, node10, node11, node12, node13, node14, node15]
        rods = [rod1, rod2, rod3, rod4, rod5, rod6, rod7, rod8, rod9, rod10, rod11, rod12, rod13, rod14]
...
def create_primary_system_23(params: dict):
    l1 = params["l1"]
    l2 = params["l2"]
    h1 = params["h1"]
    h2 = params["h2"]
    ...
    support3 = Support(node=node11, number_of_reactions=2, rotation=90)
    support4 = Support(node=node15, number_of_reactions=2, rotation=90)
    ...
    loads['p'] = loads_p
    loads['k'] = [load_k]
    supports = [support3, support4]

    details['equation_of_static_determinacy'] = ' 3 · 3 - 4 = 5'
