...
def create_frame_21(params: dict):
    ...
    node16 = Node(name='16', x=l1 * 0.5 + l2, y=h1 * 0.5)
    ...
    rod7_1 = Rod(start_node=node5, end_node=node16, is_start_hinge=True)
    rod7_2 = Rod(start_node=node16, end_node=node12, is_end_hinge=True)
    ...
    if load_index == 1:
        ...
        rods = [rod1_1, rod1_2, rod2, rod3, rod4, rod5, rod6, rod7_1, rod7_2, rod8, rod9, rod10, rod11, rod12, rod13_1, rod13_2]
