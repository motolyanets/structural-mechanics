...
def create_frame_19(params: dict):
    ...
    node18 = Node(name='18', x=l1 * 1 / 3 + l2 + l1 * 0.5, y=h1 + h2)
    ...
    rod8_1 = Rod(start_node=node7, end_node=node18)
    rod8_2 = Rod(start_node=node18, end_node=node11)
    ...
    rod13 = Rod(start_node=node13, end_node=node14, stiffness=i3)
    rod15 = Rod(start_node=node16, end_node=node17, stiffness=i2)
    ...
    if load_index == 1:
        ...
        rod14_1 = Rod(start_node=node16, end_node=node15)
        rod14_2 = Rod(start_node=node15, end_node=node14)
        ...
        loads = [load_P1, load_P2, load_P3, load_q1, load_q2, load_q3, load_q4]
        nodes = [node1, node2, node3, node4, node5, node6, node7, node8, node9, node10, node11, node12, node14, node15, node16, node17, node18]
        rods = [rod1, rod2_1, rod2_2, rod3, rod4, rod5, rod6, rod7, rod8_1, rod8_2, rod9, rod10, rod11, rod12, rod13, rod14_1, rod14_2, rod15]
        ...
        load_q2 = DistributedForce(name='q', rod=rod14, value=q, rotation=180)
        loads = [load_P1, load_P2, load_q1, load_q2]
        nodes = [node1, node2, node4, node5, node6, node7, node8, node9, node10, node11, node12, node14, node16, node17, node18]
    ...
    symmetry = ('x', node9)
    details = dict()
    details['node_name_for_static_check'] = 'C'
