...
class MovementMethodLoader(BaseExcelLoader):
    """
    ...
    def load_cipher(self, cipher: str) -> Dict[str, Any]:
        ...
        circuit_part1 = first_data.get("variant")
        circuit_part2 = first_data.get("circuit_part")
        ...
        return {
            ...
            "variant": int(first_data.get("variant", 0)),
            "l1": float(second_data.get("l1", 0)),
            "l2": float(second_data.get("l2", 0)),
            "h1": float(third_data.get("h1", 0)),
            "h2": float(third_data.get("h2", 0)),
            "q": float(fourth_data.get("q", 0)),
            "P": float(fourth_data.get("p", 0)),
        }
