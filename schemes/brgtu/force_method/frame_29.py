...
def create_frame_29(params: dict):
    ...
    node8 = Node(name='8', x=l2 + l1 * 0.4, y=h2 + h1 * 0.75)
    ...
    node18 = Node(name='18', x=l2 + l1 * 0.8, y=h1 * 0.5)
    ...
    rod14_1 = Rod(start_node=node6, end_node=node18, is_start_hinge=True)
    rod14_2 = Rod(start_node=node18, end_node=node13, is_end_hinge=True)
    ...
    if load_index == 1:
        ...
        rods = [rod1, rod2, rod3, rod4, rod5, rod6, rod7, rod8, rod9, rod10, rod11, rod12_1, rod12_2, rod13, rod14_1, rod14_2]
    else:
        ...
        rods = [rod1, rod2, rod3, rod4, rod5, rod6, rod7_1, rod7_2, rod8_1, rod8_2, rod9, rod10, rod11, rod12_1, rod12_2, rod13, rod14_1, rod14_2]
