...
def create_frame_14(params: dict):
    ...
    rod8 = Rod(start_node=node7, end_node=node12, is_start_hinge=True, is_end_hinge=True)
    ...
    if load_index == 1:
        ...
        rods = [rod1, rod2, rod3, rod4, rod5, rod6, rod7, rod8, rod9, rod10, rod11, rod12, rod13, rod14, rod15]
        ...
        nodes = [node1, node3, node4, node5, node6, node7, node8, node9, node10, node11, node12, node13, node14, node16, node17]
        rods = [rod1_1, rod1_2, rod2, rod3, rod4, rod5, rod6, rod7, rod8, rod9, rod10, rod11, rod12, rod13, rod14, rod15_1, rod15_2]
