...
def create_frame_10(params: dict):
    ...
    node17 = Node(name='17', x=l1 + l2, y=h1 * 0.8)
    ...
    if load_index == 1:
        ...
        nodes = [node1, node3, node4, node5, node6, node7, node8, node9, node11, node12, node13, node14, node16, node17]
        rods = [rod1, rod2, rod3, rod4, rod5, rod6, rod7_1, rod7_2, rod8, rod9, rod10, rod11_1, rod11_2, rod12]
        ...
        load_q3 = DistributedForce(name='q', rod=rod11_1, value=q, rotation=180)
        load_q4 = DistributedForce(name='q', rod=rod11_2, value=q, rotation=180)
        ...
        rods = [rod1_1, rod1_2, rod2, rod3, rod4, rod5, rod6, rod7_1, rod7_2, rod8, rod9, rod10, rod11_1, rod11_2, rod12_1, rod12_2]
